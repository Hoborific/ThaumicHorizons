...
public class ItemInjector extends ItemBow implements IRepairable
{
    ...
    public void onPlayerStoppedUsing(final ItemStack p_77615_1_, final World p_77615_2_, final EntityPlayer p_77615_3_, final int p_77615_4_) {
        ...
        if (this.getAmmo(p_77615_1_, 0) != null) {
            ...
            if (this.getAmmo(p_77615_1_, 0).getItemDamage() == 0) {
                final EntitySyringe entityarrow = new EntitySyringe(p_77615_2_, (EntityLivingBase)p_77615_3_, f * 2.0f, this.getAmmo(p_77615_1_, 0).stackTagCompound);
                if (f == 1.0f) {
                ...
                projectile = (IProjectile)new EntityBlastPhial(p_77615_2_, (EntityLivingBase)p_77615_3_, f * 2.0f, this.getAmmo(p_77615_1_, 0));
            }
            p_77615_1_.damageItem(1, (EntityLivingBase)p_77615_3_);
            p_77615_2_.playSoundAtEntity((Entity)p_77615_3_, "random.bow", 1.0f, 1.0f / (ItemInjector.itemRand.nextFloat() * 0.4f + 1.2f) + f * 0.5f);
    ...
    public ItemStack onItemRightClick(final ItemStack p_77659_1_, final World p_77659_2_, final EntityPlayer p_77659_3_) {
        if (p_77659_3_.isSneaking()) {
            p_77659_3_.openGui((Object)ThaumicHorizons.instance, 6, p_77659_2_, MathHelper.floor_double(p_77659_3_.posX), MathHelper.floor_double(p_77659_3_.posY), MathHelper.floor_double(p_77659_3_.posZ));
        }
        else if (this.getAmmo(p_77659_1_, 0) == null) {
            this.rotateAmmo(p_77659_1_);
            p_77659_2_.playSoundEffect(p_77659_3_.posX, p_77659_3_.posY + p_77659_3_.getEyeHeight(), p_77659_3_.posZ, "random.click", 1.0f, 1.0f);
        }
        else {
