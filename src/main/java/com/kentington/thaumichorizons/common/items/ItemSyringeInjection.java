...
public class ItemSyringeInjection extends ItemPotion
{
    ...
    public ItemStack onItemRightClick(final ItemStack p_77659_1_, final World p_77659_2_, final EntityPlayer p_77659_3_) {
        if (this.isPhial(p_77659_1_.getItemDamage())) {
            ...
            p_77659_2_.playSoundAtEntity((Entity)p_77659_3_, "random.bow", 0.5f, 0.4f / (ItemSyringeInjection.itemRand.nextFloat() * 0.4f + 0.8f));
    ...
    public void addInformation(final ItemStack p_77624_1_, final EntityPlayer p_77624_2_, final List p_77624_3_, final boolean p_77624_4_) {
            ...
            for (PotionEffect potioneffect : list1) {
                ...
                if (map != null && map.size() > 0) {
                    for (final Map.Entry entry : mapset) {
                        ...
                        final AttributeModifier attributemodifier2 = new AttributeModifier(attributemodifier.getName(), potion.func_111183_a(potioneffect.getAmplifier(), attributemodifier), attributemodifier.getOperation());
        ...
        if (!hashmultimap.isEmpty()) {
            ...
            for (final Map.Entry entry2 : (List<Map.Entry>) hashmultimap.entries()) {
                ...
                if (d0 > 0.0) {
                    p_77624_3_.add(EnumChatFormatting.BLUE + StatCollector.translateToLocalFormatted("attribute.modifier.plus." + attributemodifier3.getOperation(), new Object[] { ItemStack.field_111284_a.format(d2), StatCollector.translateToLocal("attribute.name." + entry2.getKey()) }));
                }
                else {
                    if (d0 >= 0.0) {
                        continue;
                    ...
                    d2 *= -1.0;
                    p_77624_3_.add(EnumChatFormatting.RED + StatCollector.translateToLocalFormatted("attribute.modifier.take." + attributemodifier3.getOperation(), new Object[] { ItemStack.field_111284_a.format(d2), StatCollector.translateToLocal("attribute.name." + entry2.getKey()) }));
                }
            }
        }
    }
