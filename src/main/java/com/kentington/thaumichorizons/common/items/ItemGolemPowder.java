...
public class ItemGolemPowder extends Item
{
    ...
    public boolean onItemUse(final ItemStack p_77648_1_, final EntityPlayer player, final World world, final int p_77648_4_, final int p_77648_5_, final int p_77648_6_, final int p_77648_7_, final float p_77648_8_, final float p_77648_9_, final float p_77648_10_) {
        ...
        if (!blocky.hasTileEntity(md) && !blocky.isAir((IBlockAccess)world, p_77648_4_, p_77648_5_, p_77648_6_) && (blocky.isOpaqueCube() || ItemFocusAnimation.isWhitelisted(blocky, md)) && blocky.getBlockHardness(world, p_77648_4_, p_77648_5_, p_77648_6_) != -1.0f) {
            ...
            if (!world.isRemote) {
                ...
                final BlockEvent.BreakEvent event = ForgeHooks.onBlockBreakEvent(player.worldObj, gt, (EntityPlayerMP)player, p_77648_4_, p_77648_5_, p_77648_6_);
                if (event.isCanceled()) {
                    golem.setDead();
                    return false;
                }
                world.setBlockToAir(p_77648_4_, p_77648_5_, p_77648_6_);
                world.playSoundEffect(p_77648_4_ + 0.5, p_77648_5_ + 0.5, p_77648_6_ + 0.5, "thaumcraft:wand", 1.0f, 1.0f);
