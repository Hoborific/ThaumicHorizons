...
public class WandManagerTH implements IWandTriggerManager
{
    ...
    boolean constructVat(final World world, final ItemStack itemstack, final EntityPlayer player, final int x, final int y, final int z, final int side) {
    ...
    boolean fitVat(final World world, final int x, final int y, final int z) {
        ...
        final Block[][][] blueprint = { { { p, p, p }, { p, a, p }, { p, p, p } }, { { g, g, g }, { g, w, g }, { g, g, g } }, { { g, g, g }, { g, w, g }, { g, g, g } }, { { p, p, p }, { p, a, p }, { p, p, p } } };
            ...
            for (int zz = 0; zz < 3; ++zz) {
                for (int xx = 0; xx < 3; ++xx) {
                    ...
                    if (world.getBlock(x + xx, y + yy, z + zz) == Blocks.water || world.getBlock(x + xx, y + yy, z + zz) == Blocks.flowing_water) {
                        ...
                        if (yy == 0 && ((xx == 1 && zz == 0) || (xx == 1 && zz == 2) || (xx == 0 && zz == 1) || (xx == 2 && zz == 1))) {
                            md = 4;
                        }
                        else {
                            md = 5;
