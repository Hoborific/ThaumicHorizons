...
public class ContainerFingers extends Container
{
    ...
    public ContainerFingers(final InventoryPlayer par1InventoryPlayer) {
        ...
        ((ContainerFingers)(this.tileEntity.eventHandler = this)).addSlotToContainer((Slot)new SlotCraftingArcaneWorkbench(par1InventoryPlayer.player, (IInventory)this.tileEntity, (IInventory)this.tileEntity, 9, 160, 64));
        this.addSlotToContainer((Slot)new SlotLimitedByWand((IInventory)this.tileEntity, 10, 160, 24));
        for (int var6 = 0; var6 < 3; ++var6) {
            for (int var7 = 0; var7 < 3; ++var7) {
                this.addSlotToContainer(new Slot((IInventory)this.tileEntity, var7 + var6 * 3, 40 + var7 * 24, 40 + var6 * 24));
            }
        }
        for (int var6 = 0; var6 < 3; ++var6) {
            for (int var7 = 0; var7 < 9; ++var7) {
                this.addSlotToContainer(new Slot((IInventory)par1InventoryPlayer, var7 + var6 * 9 + 9, 16 + var7 * 18, 151 + var6 * 18));
            }
        }
    ...
    public void onCraftMatrixChanged(final IInventory par1IInventory) {
        ...
        if (this.tileEntity.getStackInSlot(9) == null && this.tileEntity.getStackInSlot(10) != null && this.tileEntity.getStackInSlot(10).getItem() instanceof ItemWandCasting) {
            ...
            if (wand.consumeAllVisCrafting(this.tileEntity.getStackInSlot(10), this.ip.player, ThaumcraftCraftingManager.findMatchingArcaneRecipeAspects((IInventory)this.tileEntity, this.ip.player), false)) {
                this.tileEntity.setInventorySlotContentsSoftly(9, ThaumcraftCraftingManager.findMatchingArcaneRecipe((IInventory)this.tileEntity, this.ip.player));
            }
        }
    }
