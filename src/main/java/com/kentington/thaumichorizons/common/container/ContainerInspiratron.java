...
public class ContainerInspiratron extends Container
{
    ...
    public ContainerInspiratron(final InventoryPlayer p_i1812_1_, final TileInspiratron p_i1812_2_) {
        ...
        this.addSlotToContainer((Slot)new SlotRestricted((IInventory)p_i1812_2_, 0, 15, 42, new ItemStack(Items.paper)));
        this.addSlotToContainer((Slot)new SlotRestricted((IInventory)p_i1812_2_, 1, 146, 42, new ItemStack(ConfigItems.itemResource, 1, 9)));
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
