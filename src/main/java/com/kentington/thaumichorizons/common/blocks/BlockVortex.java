        ...
        if (entity instanceof EntityPlayer) {
            ...
            for (int numAspects = world.rand.nextInt(4) + 1, a = 0; a < numAspects; ++a) {
                if (world.rand.nextInt(3) == 0) {
                    tile.aspects.add(Aspect.getCompoundAspects().get(world.rand.nextInt(Aspect.getCompoundAspects().size())), world.rand.nextInt(30));
                }
                else {
                    tile.aspects.add(Aspect.getPrimalAspects().get(world.rand.nextInt(Aspect.getPrimalAspects().size())), world.rand.nextInt(30));
                }
            }
        }
