...
public class BlockSoulJarItem extends ItemBlock
{
    ...
    public boolean onItemUse(final ItemStack stack, final EntityPlayer player, final World world, int x, int y, int z, int side, final float par8, final float par9, final float par10) {
        ...
        if (world.canPlaceEntityOnSide(ThaumicHorizons.blockJar, x, y, z, false, side, (Entity)player, stack)) {
            ...
            if (this.placeBlockAt(stack, player, world, x, y, z, side, par8, par9, par10, var14)) {
                ...
                world.playSoundEffect((double)(x + 0.5f), (double)(y + 0.5f), (double)(z + 0.5f), var12.stepSound.func_150496_b(), (var12.stepSound.getVolume() + 1.0f) / 2.0f, var12.stepSound.getPitch() * 0.8f);
                --stack.stackSize;
            }
            return true;
        }
