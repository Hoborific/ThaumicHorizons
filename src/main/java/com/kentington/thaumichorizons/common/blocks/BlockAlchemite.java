...
public class BlockAlchemite extends BlockTNT
{
    ...
    public void onBlockDestroyedByExplosion(final World p_149723_1_, final int p_149723_2_, final int p_149723_3_, final int p_149723_4_, final Explosion p_149723_5_) {
        if (!p_149723_1_.isRemote) {
            final EntityAlchemitePrimed entitytntprimed = new EntityAlchemitePrimed(p_149723_1_, p_149723_2_ + 0.5f, p_149723_3_ + 0.5f, p_149723_4_ + 0.5f, p_149723_5_.getExplosivePlacedBy());
    ...
    public void func_150114_a(final World p_150114_1_, final int p_150114_2_, final int p_150114_3_, final int p_150114_4_, final int p_150114_5_, final EntityLivingBase p_150114_6_) {
        if (!p_150114_1_.isRemote && (p_150114_5_ & 0x1) == 0x1) {
            final EntityAlchemitePrimed entitytntprimed = new EntityAlchemitePrimed(p_150114_1_, p_150114_2_ + 0.5f, p_150114_3_ + 0.5f, p_150114_4_ + 0.5f, p_150114_6_);
    ...
    public IIcon getIcon(final int p_149691_1_, final int p_149691_2_) {
        return (p_149691_1_ == 0) ? BlockAlchemite.blockIconBottom : ((p_149691_1_ == 1) ? BlockAlchemite.blockIconTop : this.blockIcon);
    }
