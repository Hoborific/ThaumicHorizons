...
public class BlockSyntheticNode extends BlockContainer
{
    ...
    public void breakBlock(final World p_149749_1_, final int p_149749_2_, final int p_149749_3_, final int p_149749_4_, final Block p_149749_5_, final int p_149749_6_) {
        final TileSyntheticNode tile = (TileSyntheticNode)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
        if (tile != null) {
            for (final Aspect asp : tile.getMaxAspects().getAspects()) {
                final ItemStack essence = new ItemStack(ConfigItems.itemWispEssence, tile.getMaxAspects().getAmount(asp) / 4);
                ((ItemWispEssence)ConfigItems.itemWispEssence).setAspects(essence, new AspectList().add(asp, 2));
                p_149749_1_.spawnEntityInWorld((Entity)new EntityItem(p_149749_1_, (double)p_149749_2_, (double)p_149749_3_, (double)p_149749_4_, essence));
            }
        }
