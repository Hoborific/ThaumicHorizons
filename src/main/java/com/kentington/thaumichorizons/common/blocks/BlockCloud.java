...
public class BlockCloud extends BlockContainer {
    ...
    private void func_150186_m(
            final World p_150186_1_, final int p_150186_2_, final int p_150186_3_, final int p_150186_4_) {
    ...
    public boolean onBlockActivated(
        ...
        if (!world.isRemote
                ...
                && ResearchManager.isResearchComplete(player.getCommandSenderName(), "planarClouds")
                && ((ItemWandCasting) player.getHeldItem().getItem())
                        .consumeVis(player.getHeldItem(), player, Aspect.AIR, 100, false)) {
            world.spawnEntityInWorld((Entity) new EntityItemInvulnerable(
                    world, x + 0.5, y + 0.5, z + 0.5, new ItemStack((Block) this, 1, world.getBlockMetadata(x, y, z))));
    ...
    public boolean shouldSideBeRendered(
            final IBlockAccess p_149646_1_,
            final int p_149646_2_,
            final int p_149646_3_,
            final int p_149646_4_,
            final int p_149646_5_) {
        final Block block = p_149646_1_.getBlock(p_149646_2_, p_149646_3_, p_149646_4_);
        return block != this
                || p_149646_1_.getBlockMetadata(p_149646_2_, p_149646_3_, p_149646_4_)
