...
public class CommonProxy implements IGuiHandler
{
    ...
    public void essentiaTrailEntityFx(final WorldClient world, final int posX, final int posY, final int posZ, final Entity end, final int i, final int color, final float scale) {
    }
