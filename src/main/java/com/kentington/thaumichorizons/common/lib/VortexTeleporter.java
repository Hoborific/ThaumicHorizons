...
public class VortexTeleporter extends Teleporter
{
    ...
    public void placeInPortal(final Entity p_77185_1_, final double p_77185_2_, final double p_77185_4_, final double p_77185_6_, final float p_77185_8_) {
        if (this.worldServerInstance.provider.dimensionId != 0) {
            ...
            p_77185_1_.setPosition(PocketPlaneData.positions.get(this.planeNum).xCoord, PocketPlaneData.positions.get(this.planeNum).yCoord, PocketPlaneData.positions.get(this.planeNum).zCoord);
        }
    }
}
