...
public class ThaumicHorizons {
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        selfRecipes.add(new SelfInfusionRecipe("warpedTumor", 12, (new AspectList()).add(Aspect.TAINT, 64).add(Aspect.ELDRITCH, 64).add(Aspect.TRAP, 48).add(Aspect.FLESH, 32).add(Aspect.EXCHANGE, 32), new ItemStack[]{new ItemStack(ConfigBlocks.blockTaint, 1, 2), new ItemStack(ConfigItems.itemBathSalts, 1, 0), new ItemStack(Items.nether_star), new ItemStack(ConfigItems.itemResource, 1, 17), new ItemStack(ConfigItems.itemSanitySoap, 1, 0),  new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 0), new ItemStack(ConfigItems.itemBathSalts, 1, 0),  new ItemStack(Items.nether_star), new ItemStack(ConfigItems.itemResource, 1, 17), new ItemStack(ConfigItems.itemSanitySoap, 1, 0)}, 8));
