...
public class ThaumicHorizons {
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        if(enablePocket) {
            ...
            ResearchItem infusion9 = new ResearchItem("planarKeystone", "ThaumicHorizons", (new AspectList()).add(Aspect.TRAVEL, 15).add(Aspect.VOID, 12).add(Aspect.AURA, 9).add(Aspect.ELDRITCH, 6).add(Aspect.MAGIC, 3), 20, 8, 4, new ItemStack(blockSlot));
            infusion10 = new ResearchPage("planarKeystone1");
            recipeKeystone = ThaumcraftApi.addInfusionCraftingRecipe("planarKeystone", new ItemStack(itemKeystone), 9, (new AspectList()).add(Aspect.TRAVEL, 64).add(Aspect.VOID, 48).add(Aspect.MECHANISM, 32).add(Aspect.ELDRITCH, 32), new ItemStack(Items.ender_eye), new ItemStack[]{new ItemStack(ConfigItems.itemShard, 1, 6), new ItemStack(ConfigItems.itemResource, 1, 3),  GT_OreDictUnificator.get(OrePrefixes.lens, Materials.Glass, 1L), new ItemStack(ConfigItems.itemResource, 1, 3), new ItemStack(ConfigItems.itemShard, 1, 6), new ItemStack(ConfigItems.itemResource, 1, 3), GT_OreDictUnificator.get(OrePrefixes.lens, Materials.Glass, 1L), new ItemStack(ConfigItems.itemResource, 1, 3),});
            infusion11 = new ResearchPage(recipeKeystone);
            infusion12 = new ResearchPage("planarKeystone2");
            recipeSlot = ThaumcraftApi.addInfusionCraftingRecipe("planarKeystone", new ItemStack(blockSlot), 12, (new AspectList()).add(Aspect.VOID, 48).add(Aspect.TRAVEL, 64).add(Aspect.AIR, 64).add(Aspect.MECHANISM, 32).add(Aspect.ELDRITCH, 64).add(Aspect.MAGIC, 16), new ItemStack(itemPlanarConduit), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Void, 1L), GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Titanium, 1L), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.InfusedGold, 1L), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Void, 1L), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.InfusedGold, 1L), GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Thaumium, 1L), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Void, 1L), GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Thaumium, 1L), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.InfusedGold, 1L), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Void, 1L), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.InfusedGold, 1L), GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Thaumium, 1L)});
