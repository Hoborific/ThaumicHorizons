...
public class ThaumicHorizons {
    ...
    public static final String VERSION = "1.1.9.15";
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        selfRecipes.add(new SelfInfusionRecipe("warpedTumor", 15, (new AspectList()).add(Aspect.TAINT, 64).add(Aspect.ELDRITCH, 64).add(Aspect.TRAP, 48).add(Aspect.FLESH, 32).add(Aspect.EXCHANGE, 32).add(Aspect.MAN, 16), new ItemStack[]{new ItemStack(ConfigBlocks.blockTaint, 1, 2), new ItemStack(ConfigItems.itemBathSalts, 1, 0), new ItemStack(Items.nether_star, 1, 0), new ItemStack(ConfigItems.itemResource, 1, 17), new ItemStack(ConfigItems.itemSanitySoap, 1, 0),  new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 0), new ItemStack(ConfigItems.itemBathSalts, 1, 0),  new ItemStack(Items.nether_star, 1, 0), new ItemStack(ConfigItems.itemResource, 1, 17), new ItemStack(ConfigItems.itemSanitySoap, 1, 0), }, 8));
        selfRecipes.add(new SelfInfusionRecipe("spiderClimb", 8, (new AspectList()).add(Aspect.BEAST, 32).add(Aspect.MOTION, 48).add(Aspect.SLIME, 32), new ItemStack[]{new ItemStack(Blocks.web), new ItemStack(ConfigItems.itemResource, 1, 7), new ItemStack(Blocks.web), new ItemStack(Blocks.ladder), new ItemStack(Blocks.web), new ItemStack(ConfigItems.itemResource, 1, 0), new ItemStack(Blocks.web), new ItemStack(Blocks.ladder)}, 9));
