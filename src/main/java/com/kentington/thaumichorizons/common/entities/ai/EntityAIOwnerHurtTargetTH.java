...
public class EntityAIOwnerHurtTargetTH extends EntityAITarget
{
    ...
    public boolean shouldExecute() {
        final EntityInfusionProperties prop = (EntityInfusionProperties)this.theEntityTameable.getExtendedProperties("CreatureInfusion");
        final EntityLivingBase entitylivingbase = (EntityLivingBase)this.theEntityTameable.worldObj.getPlayerEntityByName(prop.getOwner());
