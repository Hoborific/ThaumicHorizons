...
public class EntityAIOwnerHurtByTargetTH extends EntityAITarget
{
    ...
    public boolean shouldExecute() {
        final EntityInfusionProperties prop = (EntityInfusionProperties)this.theDefendingTameable.getExtendedProperties("CreatureInfusion");
        final EntityLivingBase entitylivingbase = (EntityLivingBase)this.theDefendingTameable.worldObj.getPlayerEntityByName(prop.getOwner());
