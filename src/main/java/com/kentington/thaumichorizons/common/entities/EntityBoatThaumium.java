...
public class EntityBoatThaumium extends EntityBoat
{
    ...
    public EntityBoatThaumium(final World p_i1705_1_, final double p_i1705_2_, final double p_i1705_4_, final double p_i1705_6_) {
        this(p_i1705_1_);
    ...
    public boolean attackEntityFrom(final DamageSource p_70097_1_, final float p_70097_2_) {
        ...
        if (!this.worldObj.isRemote && !this.isDead) {
            ...
            final boolean flag = p_70097_1_.getEntity() instanceof EntityPlayer && ((EntityPlayer)p_70097_1_.getEntity()).capabilities.isCreativeMode;
    ...
    public EntityItem entityDropItem(final ItemStack p_70099_1_, final float p_70099_2_) {
        if (p_70099_1_.stackSize != 0 && p_70099_1_.getItem() != null) {
            final EntityItemInvulnerable entityitem = new EntityItemInvulnerable(this.worldObj, this.posX, this.posY + p_70099_2_, this.posZ, p_70099_1_);
