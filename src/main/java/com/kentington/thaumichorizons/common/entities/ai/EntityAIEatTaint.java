...
public class EntityAIEatTaint extends EntityAIBase
{
    ...
    private boolean findTaint() {
        for (int x = -2; x < 3; ++x) {
            for (int y = -2; y < 3; ++y) {
                for (int z = -2; z < 3; ++z) {
                    if (this.thePig.worldObj.getBlock((int)this.thePig.posX + x, (int)this.thePig.posY + y, (int)this.thePig.posZ + z).getMaterial() == Config.taintMaterial || (this.thePig.worldObj.getBlock((int)this.thePig.posX + x, (int)this.thePig.posY + y, (int)this.thePig.posZ + z) == Blocks.grass && this.thePig.worldObj.getBiomeGenForCoords((int)this.thePig.posX + x, (int)this.thePig.posZ + z).biomeID == Config.biomeTaintID)) {
                        this.targetCoordinates = Vec3.createVectorHelper((double)((int)this.thePig.posX + x), (double)((int)this.thePig.posY + y), (double)((int)this.thePig.posZ + z));
                        return true;
                    }
                }
            }
        ...
        for (int tries = 0; tries < 30; ++tries) {
            ...
            if ((this.thePig.worldObj.isAirBlock(x2, y2 + 1, z) && this.thePig.worldObj.getBlock(x2, y2, z).getMaterial() == Config.taintMaterial) || (this.thePig.worldObj.getBlock(x2, y2, z) == Blocks.grass && this.thePig.worldObj.getBiomeGenForCoords(x2, z).biomeID == Config.biomeTaintID)) {
    ...
    public void updateTask() {
        ...
        this.thePig.getLookHelper().setLookPosition(this.targetCoordinates.xCoord + 0.5, this.targetCoordinates.yCoord + 0.5, this.targetCoordinates.zCoord + 0.5, 30.0f, 30.0f);
        final double dist = this.thePig.getDistanceSq(this.targetCoordinates.xCoord + 0.5, this.targetCoordinates.yCoord + 0.5, this.targetCoordinates.zCoord + 0.5);
        if (dist <= 4.0) {
            this.eatTaint();
        }
    }
    ...
    private void eatTaint() {
        if (this.thePig.worldObj.getBlock((int)this.targetCoordinates.xCoord, (int)this.targetCoordinates.yCoord, (int)this.targetCoordinates.zCoord).getMaterial() == Config.taintMaterial) {
            ...
            this.thePig.worldObj.playSoundAtEntity((Entity)this.thePig, "random.burp", 0.2f, ((this.thePig.worldObj.rand.nextFloat() - this.thePig.worldObj.rand.nextFloat()) * 0.7f + 1.0f) * 2.0f);
    ...
    public void startExecuting() {
        this.count = 500;
        if (this.targetCoordinates != null) {
            this.thePig.getNavigator().tryMoveToXYZ(this.targetCoordinates.xCoord + 0.5, this.targetCoordinates.yCoord + 0.5, this.targetCoordinates.zCoord + 0.5, 1.0);
        }
    }
}
