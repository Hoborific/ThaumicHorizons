...
public class EntityAIEatTaint extends EntityAIBase {
                    ...
                    if (this.thePig
                            ...
                            || (this.thePig.worldObj.getBlock(
                                    ...
                                    && this.thePig.worldObj.getBiomeGenForCoords(
                                                            (int) this.thePig.posX + x, (int) this.thePig.posZ + z)
                                                    .biomeID
                                            == Config.biomeTaintID)) {
                        this.targetCoordinates = Vec3.createVectorHelper(
                                (double) ((int) this.thePig.posX + x), (double) ((int) this.thePig.posY + y), (double)
                                        ((int) this.thePig.posZ + z));
                        return true;
                    }
                }
    ...
    private void eatTaint() {
        if (this.thePig
                        .worldObj
                        .getBlock((int) this.targetCoordinates.xCoord, (int) this.targetCoordinates.yCoord, (int)
                                this.targetCoordinates.zCoord)
                        .getMaterial()
                == Config.taintMaterial) {
            ThaumicHorizons.proxy.blockSplosionFX(
                    ...
                    this.thePig.worldObj.getBlock(
                            (int) this.targetCoordinates.xCoord, (int) this.targetCoordinates.yCoord, (int)
                                    this.targetCoordinates.zCoord),
            ...
            this.cooldown = 20;
                        ...
                        == Blocks.grass
                && this.thePig.worldObj.getBiomeGenForCoords(
                                        (int) this.targetCoordinates.xCoord, (int) this.targetCoordinates.zCoord)
                                .biomeID
                        == Config.biomeTaintID) {
