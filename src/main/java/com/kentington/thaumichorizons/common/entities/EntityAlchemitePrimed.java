...
public class EntityAlchemitePrimed extends Entity
{
    ...
    public EntityAlchemitePrimed(final World p_i1730_1_, final double p_i1730_2_, final double p_i1730_4_, final double p_i1730_6_, final EntityLivingBase p_i1730_8_) {
        this(p_i1730_1_);
    ...
    private void explode() {
        final ExplosionAlchemite explosion = new ExplosionAlchemite(this.worldObj, (Entity)this.alchemitePlacedBy, this.posX, this.posY, this.posZ, 5.0f);
