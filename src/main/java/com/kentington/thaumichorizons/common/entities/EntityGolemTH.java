            ...
            if (this.getCore() == -1 && this.ticksAlive > 0) {
                ...
                if (this.ticksExisted % 10 == 0 && this.worldObj.rand.nextInt(500) == 0) {
                    ...
                    switch (this.voidCount) {
                        case 0: {
                            if (player != null) {
                                player.addChatMessage((IChatComponent)new ChatComponentText("\u00ef申5\u00ef申o" + StatCollector.translateToLocal("thaumichorizons.golemWarning1")));
                                break;
                            }
                            break;
                        }
                        case 1: {
                            if (player != null) {
                                player.addChatMessage((IChatComponent)new ChatComponentText("\u00ef申5\u00ef申o" + StatCollector.translateToLocal("thaumichorizons.golemWarning2")));
                                break;
                            }
                            break;
                        }
                        case 2: {
                            if (player != null) {
                                player.addChatMessage((IChatComponent)new ChatComponentText("\u00ef申5\u00ef申o" + StatCollector.translateToLocal("thaumichorizons.golemWarning3")));
                                break;
                            }
                            break;
                        }
