...
public class EntityAISitTH extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        final EntityInfusionProperties prop =
                (EntityInfusionProperties) this.theEntity.getExtendedProperties("CreatureInfusion");
        final EntityLivingBase entitylivingbase =
                (EntityLivingBase) this.theEntity.worldObj.getPlayerEntityByName(prop.getOwner());
        return entitylivingbase == null
                || ((this.theEntity.getDistanceSqToEntity((Entity) entitylivingbase) >= 144.0
