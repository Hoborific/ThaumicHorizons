...
public class ItemSpawnerEgg extends Item
{
    ...
    public boolean onItemUse(final ItemStack stack, final EntityPlayer player, final World world, int x, int y, int z, final int side, final float par8, final float par9, final float par10) {
        if (world.isRemote) {
            return true;
        }
