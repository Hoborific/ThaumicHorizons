...
public class EntityAIFollowPlayer extends EntityAIBase
{
    ...
    public EntityAIFollowPlayer(final EntityGolemBase p_i1625_1_, final double p_i1625_2_, final float p_i1625_4_, final float p_i1625_5_) {
    ...
    public boolean continueExecuting() {
        return !this.petPathfinder.noPath() && this.thePet.getDistanceSqToEntity((Entity)this.theOwner) > this.maxDist * this.maxDist && !this.thePet.inactive;
    }
