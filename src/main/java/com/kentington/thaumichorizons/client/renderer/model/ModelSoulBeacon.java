...
public class ModelSoulBeacon extends ModelBase {
    ...
    public ModelSoulBeacon() {
        ...
        (this.Base = new ModelRenderer(this, 0, 23)).addBox(0.0f, 0.0f, 0.0f, 16, 1, 16);
        this.Base.setRotationPoint(-8.0f, 23.0f, -8.0f);
        this.Base.setTextureSize(64, 64);
        this.Base.mirror = true;
        this.setRotation(this.Base, 0.0f, 0.0f, 0.0f);
        (this.Core = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 12, 11, 12);
        ...
        (this.Claw1A = new ModelRenderer(this, 48, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 2);
        ...
        (this.Claw2A = new ModelRenderer(this, 48, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 2);
        ...
        (this.Claw3A = new ModelRenderer(this, 48, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 2);
        ...
        (this.Claw4A = new ModelRenderer(this, 48, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 2);
        ...
        (this.Claw3B = new ModelRenderer(this, 48, 8)).addBox(0.0f, 0.0f, 0.0f, 2, 4, 1);
        ...
        (this.Claw4B = new ModelRenderer(this, 48, 8)).addBox(0.0f, 0.0f, 0.0f, 2, 4, 1);
        ...
        (this.Claw1B = new ModelRenderer(this, 48, 16)).addBox(0.0f, 0.0f, 0.0f, 1, 4, 2);
        ...
        (this.Claw2B = new ModelRenderer(this, 48, 16)).addBox(0.0f, 0.0f, 0.0f, 1, 4, 2);
        ...
        (this.Claw1C = new ModelRenderer(this, 48, 48)).addBox(0.0f, 0.0f, 0.0f, 4, 1, 2);
        ...
        (this.Claw2C = new ModelRenderer(this, 48, 48)).addBox(0.0f, 0.0f, 0.0f, 4, 1, 2);
        ...
        (this.Claw3C = new ModelRenderer(this, 0, 48)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 4);
        ...
        (this.Claw4C = new ModelRenderer(this, 0, 48)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 4);
