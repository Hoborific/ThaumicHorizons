...
public class ModelVat extends ModelBase {
    ...
    public ModelVat() {
        ...
        (this.Base = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 48, 16, 48);
        this.Base.setRotationPoint(-24.0f, 8.0f, -24.0f);
        this.Base.setTextureSize(512, 512);
        this.Base.mirror = true;
        this.setRotation(this.Base, 0.0f, 0.0f, 0.0f);
        (this.Water = new ModelRenderer(this, 256, 0)).addBox(0.0f, 0.0f, 0.0f, 40, 32, 40);
        ...
        (this.Glass = new ModelRenderer(this, 0, 128)).addBox(0.0f, 0.0f, 0.0f, 48, 32, 48);
        ...
        (this.Top = new ModelRenderer(this, 256, 128)).addBox(0.0f, 0.0f, 0.0f, 48, 14, 48);
        this.Top.setRotationPoint(-24.0f, -38.0f, -24.0f);
        this.Top.setTextureSize(512, 512);
        this.Top.mirror = true;
        this.setRotation(this.Top, 0.0f, 0.0f, 0.0f);
        (this.Hatch = new ModelRenderer(this, 0, 80)).addBox(0.0f, 0.0f, 0.0f, 16, 2, 16);
