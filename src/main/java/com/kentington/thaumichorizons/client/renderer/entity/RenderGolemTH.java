    ...
    protected int shouldRenderPass(final EntityLivingBase entity, final int pass, final float par3) {
        if (pass == 0) {
            ...
            if (((EntityGolemTH) entity).getCore() > -1) {
                ...
                final IIcon icon =
                        ConfigItems.itemGolemCore.getIconFromDamage((int) ((EntityGolemTH) entity).getCore());
                ...
                ItemRenderer.renderItemIn2D(
                        tessellator, f1, f2, f3, f4, icon.getIconWidth(), icon.getIconHeight(), 0.2f);
                GL11.glPopMatrix();
            }
            ...
            for (int a = 0; a < upgrades; ++a) {
                ...
                final IIcon icon2 =
                        ConfigItems.itemGolemUpgrade.getIconFromDamage((int) ((EntityGolemTH) entity).getUpgrade(a));
            ...
            if (pass == 1
                    && (((EntityGolemTH) entity).getGolemDecoration().length() > 0
