...
public class RenderGolemTH extends RenderGolemBase
{
    ...
    public void render(final EntityGolemTH e, final double par2, final double par4, final double par6, final float par8, final float par9) {
    ...
    protected int shouldRenderPass(final EntityLivingBase entity, final int pass, final float par3) {
        if (pass == 0) {
            ...
            if (((EntityGolemTH)entity).getCore() > -1) {
                ...
                final IIcon icon = ConfigItems.itemGolemCore.getIconFromDamage((int)((EntityGolemTH)entity).getCore());
            ...
            for (int a = 0; a < upgrades; ++a) {
                ...
                final IIcon icon2 = ConfigItems.itemGolemUpgrade.getIconFromDamage((int)((EntityGolemTH)entity).getUpgrade(a));
