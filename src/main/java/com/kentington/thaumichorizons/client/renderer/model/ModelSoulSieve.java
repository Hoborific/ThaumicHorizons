...
public class ModelSoulSieve extends ModelBase
{
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5, final float sieveMovement, final float sandScale) {
