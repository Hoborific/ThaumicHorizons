...
public class RenderWizardCow extends RenderCow
{
    ...
    public void doRender(final EntityWizardCow p_76986_1_, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        GL11.glEnable(3042);
        ...
        if (RenderWizardCow.cowAspects.containsKey(p_76986_1_.getUniqueID().toString())) {
            this.renderMyNode(p_76986_1_.posX, p_76986_1_.posY + p_76986_1_.height / 2.0f, p_76986_1_.posZ, Minecraft.getMinecraft().renderViewEntity, 32.0, true, true, 1.0f, p_76986_9_, RenderWizardCow.cowAspects.get(p_76986_1_.getUniqueID().toString()), RenderWizardCow.cowTypes.get(p_76986_1_.getUniqueID().toString()), RenderWizardCow.cowMods.get(p_76986_1_.getUniqueID().toString()));
        }
        GL11.glDisable(3042);
    }
    
    public void renderMyNode(final double x, final double y, final double z, final EntityLivingBase viewer, final double viewDistance, final boolean visible, final boolean depthIgnore, final float size, final float partialTicks, final AspectList aspects, final NodeType type, final NodeModifier mod) {
