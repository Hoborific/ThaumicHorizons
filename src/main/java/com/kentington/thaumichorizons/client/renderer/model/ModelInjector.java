...
public class ModelInjector extends ModelBase
{
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        tessellator.addVertex(this.BowR2.rotationPointX + 0.6 + f3 * 0.25, this.BowR2.rotationPointY - 0.9375, this.BowR2.rotationPointZ + 6.8125 + f3 * 0.125);
        tessellator.addVertex((this.BowR2.rotationPointX + this.BowL2.rotationPointX) / 2.0f - 2.175, this.BowR2.rotationPointY - 0.9375, this.BowR2.rotationPointZ + 6.8125 + f3 * 0.65);
        tessellator.addVertex(this.BowL2.rotationPointX - 4.95 - f3 * 0.25, this.BowL2.rotationPointY - 0.9375, this.BowL2.rotationPointZ + 6.8125 + f3 * 0.125);
        tessellator.draw();
        GL11.glEnable(2896);
        GL11.glEnable(3553);
