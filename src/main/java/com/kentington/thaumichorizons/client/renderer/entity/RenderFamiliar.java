...
public class RenderFamiliar extends RenderOcelot
{
    ...
    public void doRender(final EntityFamiliar p_76986_1_, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        ...
        if (p_76986_1_.worldObj.rand.nextFloat() > 0.97f) {
            ...
            Thaumcraft.proxy.sparkle((float)p_76986_1_.posX + p_76986_1_.width * (float)Math.cos(angle), (float)p_76986_1_.posY + p_76986_1_.height * (p_76986_1_.worldObj.rand.nextFloat() - 0.1f) * 1.2f, (float)p_76986_1_.posZ + p_76986_1_.width * (float)Math.sin(angle), 2.0f, 0, 0.0f);
        }
    }
