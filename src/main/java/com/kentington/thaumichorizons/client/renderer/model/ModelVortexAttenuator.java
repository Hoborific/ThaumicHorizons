...
public class ModelVortexAttenuator extends ModelBase {
    ...
    public ModelVortexAttenuator() {
        ...
        (this.Base = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 16, 4, 16);
        this.Base.setRotationPoint(-8.0f, 20.0f, -8.0f);
        this.Base.setTextureSize(64, 64);
        this.Base.mirror = true;
        this.setRotation(this.Base, 0.0f, 0.0f, 0.0f);
        (this.Rod = new ModelRenderer(this, 0, 20)).addBox(0.0f, 0.0f, 0.0f, 2, 12, 2);
        ...
        (this.Ring_A1 = new ModelRenderer(this, 0, 34)).addBox(0.0f, 0.0f, 0.0f, 12, 1, 1);
        ...
        (this.Ring_A2 = new ModelRenderer(this, 0, 34)).addBox(0.0f, 0.0f, 0.0f, 12, 1, 1);
        ...
        (this.Ring_A3 = new ModelRenderer(this, 0, 36)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 10);
        ...
        (this.Ring_A4 = new ModelRenderer(this, 0, 36)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 10);
        ...
        (this.Ring_B1 = new ModelRenderer(this, 0, 47)).addBox(0.0f, 0.0f, 0.0f, 8, 1, 1);
        ...
        (this.Ring_B2 = new ModelRenderer(this, 0, 47)).addBox(0.0f, 0.0f, 0.0f, 8, 1, 1);
        ...
        (this.Ring_B3 = new ModelRenderer(this, 0, 49)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 6);
        ...
        (this.Ring_B4 = new ModelRenderer(this, 0, 49)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 6);
        ...
        (this.Ring_C1 = new ModelRenderer(this, 0, 56)).addBox(0.0f, 0.0f, 0.0f, 4, 1, 1);
        ...
        (this.Ring_C2 = new ModelRenderer(this, 0, 56)).addBox(0.0f, 0.0f, 0.0f, 4, 1, 1);
        ...
        (this.Ring_C3 = new ModelRenderer(this, 0, 58)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 2);
        ...
        (this.Ring_C4 = new ModelRenderer(this, 0, 58)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 2);
