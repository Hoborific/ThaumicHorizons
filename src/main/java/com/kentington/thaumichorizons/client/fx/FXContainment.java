...
public class FXContainment extends EntityFX
{
    ...
    public void renderParticle(final Tessellator p_70539_1_, final float p_70539_2_, final float p_70539_3_, final float p_70539_4_, final float p_70539_5_, final float p_70539_6_, final float p_70539_7_) {
        ...
        p_70539_1_.addVertexWithUV((double)(f7 - p_70539_3_ * f6 - p_70539_6_ * f6), (double)(f8 - p_70539_4_ * f6), (double)(f9 - p_70539_5_ * f6 - p_70539_7_ * f6), (double)f2, (double)f4);
        p_70539_1_.addVertexWithUV((double)(f7 - p_70539_3_ * f6 + p_70539_6_ * f6), (double)(f8 + p_70539_4_ * f6), (double)(f9 - p_70539_5_ * f6 + p_70539_7_ * f6), (double)f3, (double)f4);
        p_70539_1_.addVertexWithUV((double)(f7 + p_70539_3_ * f6 + p_70539_6_ * f6), (double)(f8 + p_70539_4_ * f6), (double)(f9 + p_70539_5_ * f6 + p_70539_7_ * f6), (double)f3, (double)f5);
        p_70539_1_.addVertexWithUV((double)(f7 + p_70539_3_ * f6 - p_70539_6_ * f6), (double)(f8 - p_70539_4_ * f6), (double)(f9 + p_70539_5_ * f6 - p_70539_7_ * f6), (double)f2, (double)f5);
        GL11.glDisable(3042);
