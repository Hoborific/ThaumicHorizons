...
public class ClientProxy extends CommonProxy
{
    ...
    public void registerRenderers() {
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileNodeMonitor.class, (TileEntitySpecialRenderer)new TileNodeMonitorRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileSyntheticNode.class, (TileEntitySpecialRenderer)new TileEtherealShardRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileVisDynamo.class, (TileEntitySpecialRenderer)new TileVisDynamoRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileEssentiaDynamo.class, (TileEntitySpecialRenderer)new TileEssentiaDynamoRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileSoulExtractor.class, (TileEntitySpecialRenderer)new TileSoulSieveRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileInspiratron.class, (TileEntitySpecialRenderer)new TileInspiratronRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileSoulforge.class, (TileEntitySpecialRenderer)new TileSoulforgeRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileVatSlave.class, (TileEntitySpecialRenderer)new TileVatSlaveRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileVatMatrix.class, (TileEntitySpecialRenderer)new TileVatMatrixRender(0));
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileBloodInfuser.class, (TileEntitySpecialRenderer)new TileBloodInfuserRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileSoulBeacon.class, (TileEntitySpecialRenderer)new TileSoulBeaconRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileTransductionAmplifier.class, (TileEntitySpecialRenderer)new TileTransductionAmplifierRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileRecombinator.class, (TileEntitySpecialRenderer)new TileRecombinatorRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileVortexStabilizer.class, (TileEntitySpecialRenderer)new TileVortexStabilizerRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileVortex.class, (TileEntitySpecialRenderer)new TileVortexRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileSpike.class, (TileEntitySpecialRenderer)new TileSpikeRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileCloud.class, (TileEntitySpecialRenderer)new TileCloudRender());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileSlot.class, (TileEntitySpecialRenderer)new TileSlotRender());
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityAlchemitePrimed.class, (Render)new RenderAlchemitePrimed());
        RenderingRegistry.registerEntityRenderingHandler((Class)EntitySyringe.class, (Render)new RenderSyringe());
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityBlastPhial.class, (Render)new BlastPhialRender());
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityChocolateCow.class, (Render)new RenderChocolateCow((ModelBase)new ModelCow(), 0.7f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityOrePig.class, (Render)new RenderOreBoar((ModelBase)new ModelPig(), (ModelBase)new ModelPig(0.5f), 0.7f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityGuardianPanther.class, (Render)new RenderGuardianPanther((ModelBase)new ModelOcelot(), 1.0f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityFamiliar.class, (Render)new RenderFamiliar(new ModelFamiliar(), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityGravekeeper.class, (Render)new RenderGravekeeper((ModelBase)new ModelOcelot(), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityGoldChicken.class, (Render)new RenderGoldChicken((ModelBase)new ModelChicken(), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityScholarChicken.class, (Render)new RenderScholarChicken((ModelBase)new ModelChicken(), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityTaintPig.class, (Render)new RenderTaintfeeder((ModelBase)new ModelPig(), (ModelBase)new ModelPig(0.5f), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityNetherHound.class, (Render)new RenderNetherHound((ModelBase)new ModelWolf(), (ModelBase)new ModelWolf(), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntitySeawolf.class, (Render)new RenderSeawolf((ModelBase)new ModelWolf(), (ModelBase)new ModelWolf(), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityLunarWolf.class, (Render)new RenderLunarWolf((ModelBase)new ModelWolf(), (ModelBase)new ModelWolf(), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityGolemTH.class, (Render)new RenderGolemTH((ModelBase)new ModelGolemTH(false)));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityEndersteed.class, (Render)new RenderEndersteed((ModelBase)new ModelHorse(), 0.75f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityNightmare.class, (Render)new RenderNightmare((ModelBase)new ModelHorse(), 0.75f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityBoatGreatwood.class, (Render)new RenderBoatGreatwood());
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityBoatThaumium.class, (Render)new RenderBoatThaumium());
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityMeatSlime.class, (Render)new RenderMeatSlime((ModelBase)new ModelSlime(16), (ModelBase)new ModelSlime(0), 0.25f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityMercurialSlime.class, (Render)new RenderMercurialSlime((ModelBase)new ModelSlime(16), (ModelBase)new ModelSlime(0), 0.25f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityVoltSlime.class, (Render)new RenderVoltSlime((ModelBase)new ModelSlime(16), (ModelBase)new ModelSlime(0), 0.25f));
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityMedSlime.class, (Render)new RenderMedSlime((ModelBase)new ModelSlime(16), (ModelBase)new ModelSlime(0), 0.25f));
        ...
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityLightningBoltFinite.class, (Render)new RenderLightningBoltFinite());
        MinecraftForgeClient.registerItemRenderer(ThaumicHorizons.itemSyringeBloodSample, (IItemRenderer)new ItemSyringeRender());
        MinecraftForgeClient.registerItemRenderer(ThaumicHorizons.itemSyringeHuman, (IItemRenderer)new ItemSyringeRender());
        MinecraftForgeClient.registerItemRenderer(ThaumicHorizons.itemSyringeEmpty, (IItemRenderer)new ItemSyringeRender());
        MinecraftForgeClient.registerItemRenderer(ThaumicHorizons.itemSyringeInjection, (IItemRenderer)new ItemSyringeRender());
        MinecraftForgeClient.registerItemRenderer(ThaumicHorizons.itemCorpseEffigy, (IItemRenderer)new ItemCorpseEffigyRender());
        MinecraftForgeClient.registerItemRenderer(ThaumicHorizons.itemInjector, (IItemRenderer)new ItemInjectorRender());
        MinecraftForgeClient.registerItemRenderer(ThaumicHorizons.itemWandCastingDisposable, (IItemRenderer)new ItemWandRenderer());
    }
    ...
    public void registerDisplayInformation() {
        ...
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(ThaumicHorizons.blockJar), (IItemRenderer)new ItemJarTHRenderer());
        RenderingRegistry.registerBlockHandler((ISimpleBlockRenderingHandler)new BlockJarTHRenderer());
        ClientRegistry.bindTileEntitySpecialRenderer((Class)TileSoulJar.class, (TileEntitySpecialRenderer)new TileJarTHRenderer());
    ...
    @Override
    public void disintegrateFX(final double blockX, final double blockY, final double blockZ, final EntityPlayer p, final int howMany, final boolean enlarged) {
        if (enlarged) {
            for (int x = -1; x < 2; ++x) {
                for (int y = -1; y < 2; ++y) {
                    for (int z = -1; z < 2; ++z) {
    ...
    @Override
    public void smeltFX(final double blockX, final double blockY, final double blockZ, final World w, final int howMany, final boolean enlarged) {
        if (enlarged) {
            for (int x = -1; x < 2; ++x) {
                for (int y = -1; y < 2; ++y) {
                    for (int z = -1; z < 2; ++z) {
            ...
            for (int j = 0; j < howMany; ++j) {
                final EntityFlameFX fx = new EntityFlameFX(w, blockX + 0.5, blockY + 0.5, blockZ + 0.5, (w.rand.nextDouble() - 0.5) * 0.25, (w.rand.nextDouble() - 0.5) * 0.25, (w.rand.nextDouble() - 0.5) * 0.25);
                fx.noClip = true;
                FMLClientHandler.instance().getClient().effectRenderer.addEffect((EntityFX)fx);
            }
        }
    ...
    public void soulParticles(final int blockX, final int blockY, final int blockZ, final World world) {
        for (int i = 0; i < 10; ++i) {
            final EntitySpellParticleFX fx = new EntitySpellParticleFX(world, blockX + 0.5 + (world.rand.nextDouble() - 0.5) * 0.8, blockY + 0.8, blockZ + 0.5 + (world.rand.nextDouble() - 0.5) * 0.8, 0.0, world.rand.nextDouble() * 0.25, 0.0);
            fx.noClip = true;
            FMLClientHandler.instance().getClient().effectRenderer.addEffect((EntityFX)fx);
        }
    }
    ...
    @Override
    public void containmentFX(final double blockX, final double blockY, final double blockZ, final EntityPlayer p, final Entity ent, final int times) {
    ...
    @Override
    public void illuminationFX(final World world, final int xCoord, final int yCoord, final int zCoord, final int md, final Color col) {
        if (world.rand.nextInt(9 - Thaumcraft.proxy.particleCount(2)) == 0) {
            final FXWisp ef = new FXWisp(world, (double)(xCoord + 0.55f), (double)(yCoord + 0.5f), (double)(zCoord + 0.55f), 0.5f, col.getRed() / 255.0f + 0.01f, col.getGreen() / 255.0f, col.getBlue() / 255.0f);
            ef.setGravity(0.0f);
            ef.shrink = false;
            if (md == 0) {
                ef.blendmode = 0;
    ...
    @Override
    public void lightningBolt(final World worldObj, final double x, final double y, final double z, final int boltLength) {
        Thaumcraft.proxy.arcLightning(worldObj, x + worldObj.rand.nextFloat() - 0.5, y + boltLength + 0.5, z + worldObj.rand.nextFloat() - 0.5, x + worldObj.rand.nextFloat() - 0.5, y + 1.0, z + worldObj.rand.nextFloat() - 0.5, 0.8f, 1.0f, 1.0f, 0.1f);
    }
}
